...
const struct SamusAnimationData* const sSamusAnimPointers_PowerSuit_Shinesparking[FORCED_MOVEMENT_SHINESPARK_COUNT][2] = {
...
const struct ArmCannonAnimationData* const sArmCannonAnimPointers_Suit_Shinesparking[FORCED_MOVEMENT_SHINESPARK_COUNT][2] = {
    [FORCED_MOVEMENT_UPWARDS_SHINESPARK] = {
        sArmCannonAnim_Suit_Right_Shinesparking,
        sArmCannonAnim_Suit_Left_Shinesparking
    },
...
const u8 sSamusCollisionData[SPOSE_COUNT][SCDF_COUNT] = {
    ...
    [SPOSE_CROUCHING] = {
        ...
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_CROUCHED,
        [SCDF_STANDING_STATUS] = STANDING_GROUND
    },
    [SPOSE_TURNING_AROUND_AND_CROUCHING] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_CROUCHED,
    ...
    [SPOSE_MIDAIR] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_STANDING_STATUS] = STANDING_MIDAIR
    },
    [SPOSE_TURNING_AROUND_MIDAIR] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
    ...
    [SPOSE_MORPHING] = {
        ...
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_MORPHED,
        [SCDF_STANDING_STATUS] = STANDING_GROUND
    },
    [SPOSE_MORPH_BALL] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_MORPHED,
    ...
    [SPOSE_HANGING_ON_LEDGE] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_STANDING_STATUS] = STANDING_HANGING
    },
    [SPOSE_TURNING_TO_AIM_WHILE_HANGING] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
    ...
    [SPOSE_PULLING_YOURSELF_UP_FROM_HANGING] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_STANDING_STATUS] = STANDING_FORCED_POSE
    },
    [SPOSE_PULLING_YOURSELF_FORWARD_FROM_HANGING] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
    ...
    [SPOSE_ON_ZIPLINE] = {
        [SCDF_HITBOX] = SAMUS_HITBOX_TYPE_ZIPLINE,
        [SCDF_BLOCK_HITBOX] = SAMUS_HITBOX_TYPE_STANDING,
...
const struct SamusAnimationData* const sSamusAnimPointers_FullSuit_Shinesparking[FORCED_MOVEMENT_SHINESPARK_COUNT][2] = {
    [FORCED_MOVEMENT_UPWARDS_SHINESPARK] = {
        sSamusAnim_FullSuit_Right_Shinesparking,
        sSamusAnim_FullSuit_Left_Shinesparking
    },
...
const struct SamusEffectAnimationData* const sSamusEffectAnimPointers_Shinesparking[FORCED_MOVEMENT_SHINESPARK_COUNT][2] = {
    [FORCED_MOVEMENT_UPWARDS_SHINESPARK] = {
...
const struct SamusEffectAnimationData* const sSamusEffectAnimPointers_Ballsparking[FORCED_MOVEMENT_SHINESPARK_COUNT][2] = {
    [FORCED_MOVEMENT_UPWARDS_SHINESPARK] = {
...
const s16 sSamusHitboxData[SAMUS_HITBOX_TYPE_COUNT][SAMUS_HITBOX_COUNT] = {
    ...
    [SAMUS_HITBOX_TYPE_ZIPLINE] = {
        ...
        [SAMUS_HITBOX_TOP] = -(BLOCK_SIZE * 2 - PIXEL_SIZE),
        [SAMUS_HITBOX_RIGHT] = HALF_BLOCK_SIZE - PIXEL_SIZE,
        [SAMUS_HITBOX_BOTTOM] = -EIGHTH_BLOCK_SIZE
    }
};

const s16 sSamusBlockHitboxData[SAMUS_HITBOX_TYPE_NORMAL_COUNT][SAMUS_BLOCK_HITBOX_COUNT] = {
    [SAMUS_HITBOX_TYPE_STANDING] = {
        [SAMUS_BLOCK_HITBOX_LEFT] = -(HALF_BLOCK_SIZE - PIXEL_SIZE),
        [SAMUS_BLOCK_HITBOX_RIGHT] = (HALF_BLOCK_SIZE - PIXEL_SIZE),
        [SAMUS_BLOCK_HITBOX_TOP] = -(BLOCK_SIZE * 2 - PIXEL_SIZE)
    },
    [SAMUS_HITBOX_TYPE_CROUCHED] = {
        [SAMUS_BLOCK_HITBOX_LEFT] = -(HALF_BLOCK_SIZE - PIXEL_SIZE),
        [SAMUS_BLOCK_HITBOX_RIGHT] = (HALF_BLOCK_SIZE - PIXEL_SIZE),
        [SAMUS_BLOCK_HITBOX_TOP] = -(BLOCK_SIZE + HALF_BLOCK_SIZE - PIXEL_SIZE)
    },
    [SAMUS_HITBOX_TYPE_MORPHED] = {
        [SAMUS_BLOCK_HITBOX_LEFT] = -(HALF_BLOCK_SIZE - PIXEL_SIZE),
        [SAMUS_BLOCK_HITBOX_RIGHT] = (HALF_BLOCK_SIZE - PIXEL_SIZE),
        [SAMUS_BLOCK_HITBOX_TOP] = -(BLOCK_SIZE - PIXEL_SIZE)
    }
};

const s16 sSamusBlockHitboxData_Above[SAMUS_BLOCK_HITBOX_COUNT] = {
    [SAMUS_BLOCK_HITBOX_LEFT] = -(EIGHTH_BLOCK_SIZE + PIXEL_SIZE / 2),
    [SAMUS_BLOCK_HITBOX_RIGHT] = (EIGHTH_BLOCK_SIZE + PIXEL_SIZE / 2),
    [SAMUS_BLOCK_HITBOX_TOP] = 0
};

const struct FrameData* const sSamusEnvEffectsFrameDataPointers[ENV_EFFECT_COUNT - 1] = {
...
#define PULLING_VELOCITY (PIXEL_SIZE)
const u16 sSamusPullingSelfUpVelocity[4] = {
    [0] = PULLING_VELOCITY * 6,
    [1] = PULLING_VELOCITY * 2,
    [2] = PULLING_VELOCITY * 1,
    [3] = 0
};
