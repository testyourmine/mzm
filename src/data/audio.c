...
const u32 sNativeSampleRate[SOUND_MODE_FREQ_END] = {
    [SOUND_MODE_FREQ_NONE]  = 0,
    [SOUND_MODE_FREQ_05734] = SAMPLES_PER_SECOND(96),
    [SOUND_MODE_FREQ_07884] = SAMPLES_PER_SECOND(132),
    [SOUND_MODE_FREQ_10512] = SAMPLES_PER_SECOND(176),
    [SOUND_MODE_FREQ_13379] = SAMPLES_PER_SECOND(224), // default
    [SOUND_MODE_FREQ_15768] = SAMPLES_PER_SECOND(264),
    [SOUND_MODE_FREQ_18157] = SAMPLES_PER_SECOND(304),
    [SOUND_MODE_FREQ_21024] = SAMPLES_PER_SECOND(352),
    [SOUND_MODE_FREQ_26758] = SAMPLES_PER_SECOND(448),
    [SOUND_MODE_FREQ_31536] = SAMPLES_PER_SECOND(528),
    [SOUND_MODE_FREQ_36314] = SAMPLES_PER_SECOND(608),
    [SOUND_MODE_FREQ_40137] = SAMPLES_PER_SECOND(672),
    [SOUND_MODE_FREQ_42048] = SAMPLES_PER_SECOND(704)
};

const u32 sMusicPitchData[SOUND_MODE_FREQ_END] = {
    [SOUND_MODE_FREQ_NONE]  = 0x0,
    [SOUND_MODE_FREQ_05734] = 0xB6DEB,
    [SOUND_MODE_FREQ_07884] = 0x85002,
    [SOUND_MODE_FREQ_10512] = 0x63C01,
    [SOUND_MODE_FREQ_13379] = 0x4E5FF, // default
    [SOUND_MODE_FREQ_15768] = 0x42801,
    [SOUND_MODE_FREQ_18157] = 0x39C02,
    [SOUND_MODE_FREQ_21024] = 0x31E00,
    [SOUND_MODE_FREQ_26758] = 0x272FF,
    [SOUND_MODE_FREQ_31536] = 0x21400,
    [SOUND_MODE_FREQ_36314] = 0x1CE01,
    [SOUND_MODE_FREQ_40137] = 0x1A1FF,
    [SOUND_MODE_FREQ_42048] = 0x18F00
};
...
const u32 sDma1ControlValue = C_32_2_16(DMA_ENABLE | DMA_32BIT | DMA_DEST_FIXED, sizeof(u32));
static const u16 sAudio_8cef4 = DMA_ENABLE | DMA_START_SPECIAL | DMA_32BIT | DMA_REPEAT;
static const u16 sAudio_8cef6 = DMA_ENABLE | DMA_INTR_ENABLE | DMA_START_SPECIAL | DMA_32BIT | DMA_REPEAT;
