...
MAKE_ENUM(u16, SlopeType) ENUM_FLAG {
    SLOPE_NONE   = 0,
    SLOPE_STEEP  = 1 << 0,
    SLOPE_SLIGHT = 1 << 1
};
...
MAKE_ENUM(u8, SamusCollisionDetection) ENUM_FLAG {
    SAMUS_COLLISION_DETECTION_NONE         = 0,
    SAMUS_COLLISION_DETECTION_LEFT_MOST    = 1 << 0,
    SAMUS_COLLISION_DETECTION_MIDDLE_LEFT  = 1 << 1,
    SAMUS_COLLISION_DETECTION_MIDDLE_RIGHT = 1 << 2,
    SAMUS_COLLISION_DETECTION_RIGHT_MOST   = 1 << 3,
    SAMUS_COLLISION_DETECTION_SLOPE        = 1 << 7,

    SAMUS_COLLISION_DETECTION_MIDDLE       = SAMUS_COLLISION_DETECTION_MIDDLE_LEFT | SAMUS_COLLISION_DETECTION_MIDDLE_RIGHT,
    SAMUS_COLLISION_DETECTION_LEFT         = SAMUS_COLLISION_DETECTION_LEFT_MOST | SAMUS_COLLISION_DETECTION_MIDDLE_LEFT,
    SAMUS_COLLISION_DETECTION_RIGHT        = SAMUS_COLLISION_DETECTION_RIGHT_MOST | SAMUS_COLLISION_DETECTION_MIDDLE_RIGHT
};
